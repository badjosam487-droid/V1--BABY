...
cfaText.innerText = `â‰ˆ ${currentUser.mainBalance} FCFA`;
}else{
balanceText.innerText = "â€¢â€¢â€¢â€¢";
cfaText.innerText = "â‰ˆ â€¢â€¢â€¢â€¢";
}
...
.filter(Boolean)
.map(item=>item === "X2" ? "X2" : Number(item))
.filter(item=>item === "X2" || !Number.isNaN(item));
